        ...
        LEVEL: {
          THEME: {
            GROUND: [
              ...
              new Sprite('assets/img/theme/air_t.png',512,512,1,10)
            ],
            CAVE: [
              new Sprite('assets/img/theme/cave/sprite_c_33.png',512,512,1,10), // Air (00)
              ...
              new Sprite('assets/img/theme/cave/sprite_c_34.png',512,512,1,10)
            ]
          }
        }
      };
